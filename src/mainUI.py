...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title_label.setText(_translate("MainWindow", "Friday Night Funkin\'用のスプライトシート/XML作成支援ツール"))
        self.charname_label.setText(_translate("MainWindow", "キャラクター名:"))
        self.spsh_settings_btn.setText(_translate("MainWindow", "スプライトシート\n"
"生成の設定"))
        self.posename_btn.setText(_translate("MainWindow", "アニメーション (ポーズ) 名を設定"))
        self.generatexml_btn.setText(_translate("MainWindow", "XMLを生成"))
        self.myTabs.setTabText(self.myTabs.indexOf(self.xmlframes_tab), _translate("MainWindow", "キャラクター用のスプライトシート/XML"))
        self.uploadicongrid_btn.setText(_translate("MainWindow", "アイコングリッドをアップロード"))
        self.uploadicons_btn.setText(_translate("MainWindow", "アイコンをアップロード"))
        self.use_psychengine_checkbox.setText(_translate("MainWindow", "Psych Engine 用アイコン"))
        self.iconselected_label.setText(_translate("MainWindow", "選択された\nアイコンの数:\n"
"0"))
        self.tip_label.setText(_translate("MainWindow", "ヒント: Ctrl+I、Ctrl+Oで拡大・縮小します。"))
        self.zoom_label.setText(_translate("MainWindow", "ズーム:"))
        self.generateicongrid_btn.setText(_translate("MainWindow", "新しい\n"
"アイコングリッド\nを生成"))
        self.myTabs.setTabText(self.myTabs.indexOf(self.icongrid_tab), _translate("MainWindow", "アイコングリッド"))
        self.menuFile.setTitle(_translate("MainWindow", "ファイル(&F)"))
        self.menuExport.setTitle(_translate("MainWindow", "エクスポート..."))
        self.menuImport.setTitle(_translate("MainWindow", "インポート..."))
        self.menuEdit.setTitle(_translate("MainWindow", "編集(&E)"))
        self.menuEdit_Selected_Images.setTitle(_translate("MainWindow", "選択された画像を編集"))
        self.menuFlip.setTitle(_translate("MainWindow", "反転"))
        self.menuView.setTitle(_translate("MainWindow", "ビュー(&V)"))
        self.menuDefault_Dark_mode.setTitle(_translate("MainWindow", "テーマ"))
        self.action_import_existing.setText(_translate("MainWindow", "スプライトシートをインポートする"))
        self.actionImport_Images.setText(_translate("MainWindow", "画像をインポート...."))
        self.actionClear_Spritesheet_Grid.setText(_translate("MainWindow", "スプライトシートをクリア"))
        self.actionEdit_Frame_Properties.setText(_translate("MainWindow", "フレームプロパティを編集"))
        self.actionImport_icons.setText(_translate("MainWindow", "アイコンをインポート"))
        self.actionImport_IconGrid.setText(_translate("MainWindow", "アイコングリッドをインポート"))
        self.actionImport_Icons.setText(_translate("MainWindow", "アイコンをインポート"))
        self.actionClear_IconGrid.setText(_translate("MainWindow", "アイコングリッドをクリア"))
        self.actionClear_Icon_selection.setText(_translate("MainWindow", "選択されたアイコンをクリア"))
        self.actionExport_as_Spritesheet_and_XML.setText(_translate("MainWindow", "スプライトシートとしてエクスポート"))
        self.actionExport_induvidual_images.setText(_translate("MainWindow", "単一の画像としてエクスポート"))
        self.actionPreview_Animation.setText(_translate("MainWindow", "アニメーションのプレビュー"))
        self.actiondefault.setText(_translate("MainWindow", "デフォルト"))
        self.actiondark_mode.setText(_translate("MainWindow", "ダーク"))
        self.actionView_XML_structure.setText(_translate("MainWindow", "XMLの構造を見る"))
        self.actionDefault.setText(_translate("MainWindow", "デフォルト"))
        self.actionDark.setText(_translate("MainWindow", "ダーク"))
        self.actionDefault_2.setText(_translate("MainWindow", "デフォルト"))
        self.actionDark_2.setText(_translate("MainWindow", "ダーク"))
        self.actionFlipX.setText(_translate("MainWindow", "反転(X)"))
        self.actionFlipY.setText(_translate("MainWindow", "反転(Y)"))
        self.actiontets.setText(_translate("MainWindow", "tets"))
        self.actionImport_from_GIF.setText(_translate("MainWindow", "GIFからインポート"))
